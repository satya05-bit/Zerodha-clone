    ...
    return(
        ...
        <div className='container border-top mt-5'  >
            <div className='row mt-5'>
                <div className='col'>
                    <img src='media/images/sigma_logo.svg' style={{width:"50%"}} />
                    <p>&copy; 2010 - 2026, Not Sigma Zerodha Broking Ltd. All rights reserved.</p>
                </div>
                <div className='col footer-company-col p-2'>
                    <p>Company </p>
                    ...
                    <a href='' className='text-muted'style={{textDecoration:"none"}}>Sigma.tech</a> <br />
                    <a href='' className='text-muted'style={{textDecoration:"none"}}>Press & media</a> <br />
                    <a href=''className='text-muted' style={{textDecoration:"none"}}>Sigma cares</a> <br />
                ...
                <div className='col'>
                    ...
                    <a href=''className='text-muted' style={{textDecoration:"none"}}>S-connect blog</a> <br />
