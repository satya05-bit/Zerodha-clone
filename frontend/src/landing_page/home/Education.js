    ...
    return ( 
        <div className='container mt-5'>
            <div className='row'>
                ...
                <div className='col-6'>
                    <h1 className='mb-3 fs-2'>Free and open merket education</h1>
                    ...
                    <p className='mt-5'>TradingQ&A, the most active tradng and investment community in India for all your market 
                        related queries.
                    </p>
